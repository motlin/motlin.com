...
import CommentRemovalRulesSource from '!!raw-loader!../src/claude-code-plugins/plugins/code/commands/all-comments.md';
import CommentsCommandSource from '!!raw-loader!../src/claude-code-plugins/plugins/code/commands/comments.md';
import EmojiCommandSource from '!!raw-loader!../src/claude-code-plugins/plugins/code/commands/emoji.md';
import ConflictsCommandSource from '!!raw-loader!../src/claude-code-plugins/plugins/git/skills/conflicts/SKILL.md';
...
<CodeBlock language="markdown" title=".claude-prompts/commands/all-comments.md">
  {CommentRemovalRulesSource}
</CodeBlock>

[View on GitHub](https://github.com/motlin/claude-code-plugins/blob/main/plugins/code/commands/all-comments.md)
...
[View on GitHub](https://github.com/motlin/claude-code-plugins/blob/main/plugins/code/commands/comments.md)
...
[View on GitHub](https://github.com/motlin/claude-code-plugins/blob/main/plugins/code/commands/emoji.md)
...
<CodeBlock language="markdown" title=".claude-prompts/commands/conflicts.md">
  {ConflictsCommandSource}
</CodeBlock>

[View on GitHub](https://github.com/motlin/claude-code-plugins/blob/main/plugins/git/skills/conflicts/SKILL.md)
...
For more custom command examples and their implementations, check out the [claude-code-plugins repository](https://github.com/motlin/claude-code-plugins).
