...
date: 2025-07-07
description: "Building on my workflow with /todo and /commit, I've created the /worktree command to enable parallel development using Git worktrees."
---

import CodeBlock from '@theme/CodeBlock';
import GiscusComponent from '@site/src/components/GiscusComponent';
import WorktreeCommandSource from '!!raw-loader!../src/claude-code-plugins/plugins/git/skills/worktree/SKILL.md';
...
[View on GitHub](https://github.com/motlin/claude-code-plugins/blob/main/plugins/git/skills/worktree/SKILL.md)
