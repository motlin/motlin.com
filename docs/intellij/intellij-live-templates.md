...
Use [live templates](https://www.jetbrains.com/help/idea/using-live-templates.html) to insert common constructs into your code, such as loops, conditions, various declarations, or print statements. Live templates provide a way to quickly insert frequently used code, while [postfix completions](./intellij-postfix-completions.md) offer a different approach to code generation that reduces backward caret jumps.
...
![intellij-live-logger](https://miro.medium.com/max/1400/1*MF10fzDKCNtSj7MUzAhNvw.gif)
...
![Region markers expanded](https://miro.medium.com/max/1400/1*SLY6_q0mFd0woQk8lfLIBg.png)

... down to just the label.

![Region markers collapsed](https://miro.medium.com/max/756/1*HXoB4SKcCwSNQWt_i_SqFQ.png)

To get this same functionality in XML, we need to add a live template.

![XML region template](https://miro.medium.com/max/1400/1*X3qLLKCAMXDEJyE3IxKxdw.png)
...
![XML region variables](https://miro.medium.com/max/1400/1*XrfX3gxCYBk9yodjNhG77Q.png)
