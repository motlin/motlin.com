...
import TodoGetScript from '!!raw-loader!../src/.dotfiles/bin/todo-get';
import TodoCompleteScript from '!!raw-loader!../src/.dotfiles/bin/todo-complete';
...
The `/todo` command uses two helper scripts from my dotfiles:

<CodeBlock language="python" title="todo-get">
  {TodoGetScript}
</CodeBlock>

<CodeBlock language="python" title="todo-complete">
  {TodoCompleteScript}
</CodeBlock>
