...
import styles from './PegsTestMode.module.css';
...
export default function PegsTestMode() {
  ...
  return (
    <div className={styles.container}>
      ...
      <p className={styles.instructions}>Click any card to see its mnemonic peg</p>
