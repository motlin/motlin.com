...
There are also some instructions on how to report progress back to the user. You can see the full slash command prompt [on GitHub](https://github.com/motlin/claude-code-plugins/blob/main/plugins/markdown-tasks/commands/do-all-tasks.md).
...
- The [`/todo-all` command](https://github.com/motlin/claude-code-plugins/blob/main/plugins/markdown-tasks/commands/do-all-tasks.md)
