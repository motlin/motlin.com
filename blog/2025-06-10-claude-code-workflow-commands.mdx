...
import TodoCommandSource from '!!raw-loader!../src/claude-code-plugins/plugins/markdown-tasks/skills/tasks/SKILL.md';
import CommitCommandSource from '!!raw-loader!../src/claude-code-plugins/plugins/git/skills/commit/SKILL.md';
...
You can find more examples and command definitions in the [claude-code-plugins repository](https://github.com/motlin/claude-code-plugins).
...
[View on GitHub](https://github.com/motlin/claude-code-plugins/blob/main/plugins/markdown-tasks/skills/do-one-task/SKILL.md)
...
[View on GitHub](https://github.com/motlin/claude-code-plugins/blob/main/plugins/git/skills/commit/SKILL.md)
