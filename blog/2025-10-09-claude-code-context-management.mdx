...
[The agent](https://github.com/motlin/claude-code-plugins/blob/main/plugins/markdown-tasks/agents/do-task.md) gets a task with `todo-get`, implements it, runs cleanup agents (`comment-cleaner`, `precommit-runner`, `git-commit-handler`, `git-rebaser`), and marks it complete with `todo-complete`.
...
There are also some instructions on how to report progress back to the user. You can see the full slash command prompt [on GitHub](https://github.com/motlin/claude-code-plugins/blob/main/plugins/markdown-tasks/skills/do-all-tasks/SKILL.md).
...
- The [`/todo-all` command](https://github.com/motlin/claude-code-plugins/blob/main/plugins/markdown-tasks/skills/do-all-tasks/SKILL.md)
- The [`do-todo` agent](https://github.com/motlin/claude-code-plugins/blob/main/plugins/markdown-tasks/agents/do-task.md)
- The four cleanup agents: [`comment-cleaner`](https://github.com/motlin/claude-code-plugins/blob/main/plugins/code/agents/comment-cleaner.md), [`precommit-runner`](https://github.com/motlin/claude-code-plugins/blob/main/plugins/build/agents/precommit-runner.md), [`git-commit-handler`](https://github.com/motlin/claude-code-plugins/blob/main/plugins/git/agents/commit-handler.md), [`git-rebaser`](https://github.com/motlin/claude-code-plugins/blob/main/plugins/git/agents/rebaser.md)
