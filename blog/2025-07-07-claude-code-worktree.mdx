...
import WorktreeCommandSource from '!!raw-loader!../src/claude-code-plugins/plugins/git/commands/worktree.md';
...
[View on GitHub](https://github.com/motlin/claude-code-plugins/blob/main/plugins/git/commands/worktree.md)
