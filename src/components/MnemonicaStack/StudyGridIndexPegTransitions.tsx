...
export interface StudyGridIndexPegTransitionsProps {
...
export const StudyGridIndexPegTransitions: React.FC<StudyGridIndexPegTransitionsProps> = ({
  mnemonicaData,
  cardSize = 150,
  transitionSize = 100,
  gap = '1rem',
  ...
  for (let index = 0; index < mnemonicaData.length; index++) {
    ...
    const cardItem = (
      <FlippableCard
        ...
        backComponent={<MnemonicCard card={entry.card} size={cardSize} />}
        size={cardSize}
      />
    );
...
export default StudyGridIndexPegTransitions;
