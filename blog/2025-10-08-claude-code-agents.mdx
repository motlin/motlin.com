...
import CommentCleanerSource from '!!raw-loader!../src/claude-code-plugins/plugins/code/agents/comment-cleaner.md';
import PrecommitRunnerSource from '!!raw-loader!../src/claude-code-plugins/plugins/build/agents/precommit-runner.md';
import GitCommitHandlerSource from '!!raw-loader!../src/claude-code-plugins/plugins/git/agents/commit-handler.md';
import GitRebaserSource from '!!raw-loader!../src/claude-code-plugins/plugins/git/agents/rebaser.md';
...
In my [`~/.claude/CLAUDE.md`](https://github.com/motlin/claude-code-plugins/tree/main/plugins/build), I specify four agents that should run when code changes are ready:
...
[View on GitHub](https://github.com/motlin/claude-code-plugins/blob/main/plugins/code/agents/comment-cleaner.md)
...
[View on GitHub](https://github.com/motlin/claude-code-plugins/blob/main/plugins/build/agents/precommit-runner.md)
...
[View on GitHub](https://github.com/motlin/claude-code-plugins/blob/main/plugins/git/agents/commit-handler.md)
...
You can copy my agents directly from [my GitHub repo](https://github.com/motlin/claude-code-plugins) or create your own with `/agents`. Start with something simple - maybe just the comment cleaner - and see how it changes your workflow.
