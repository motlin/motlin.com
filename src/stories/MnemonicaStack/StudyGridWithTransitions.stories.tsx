...
import { StudyGridWithTransitions } from '../../components/MnemonicaStack/StudyGridWithTransitions';
import mnemonicaData from '../../data/mnemonicaData.json';

const meta = {
  title: 'MnemonicaStack/StudyGridWithTransitions',
  component: StudyGridWithTransitions,
  parameters: {
    layout: 'padded',
  },
  tags: ['autodocs'],
...
} satisfies Meta<typeof StudyGridWithTransitions>;
