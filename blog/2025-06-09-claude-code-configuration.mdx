...
authors: [craig]
tags: [claude-code, developer-productivity, configuration]
date: 2025-06-09
---
...
import GitCommitsSource from '!!raw-loader!../src/.claude-prompts/instructions/git-commits.md';
...
My commit message style instructions are also applicable to LLMs and human developers.

<CodeBlock language="markdown" title=".claude-prompts/instructions/git-commits.md">
  {GitCommitsSource}
</CodeBlock>

[View on GitHub](https://github.com/motlin/claude-code-prompts/blob/main/instructions/git-commits.md)
