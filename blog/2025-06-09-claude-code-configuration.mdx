...
date: 2025-06-09
description: "How to configure Claude Code using CLAUDE.md files and settings.json. Covers configuration, code style, and prompts that work for humans and LLMs."
---

import CodeBlock from '@theme/CodeBlock';
import GiscusComponent from '@site/src/components/GiscusComponent';
import settingsContent from '!!raw-loader!../src/.claude-prompts/settings.json';
import OrchestrationSource from '!!raw-loader!../src/claude-code-plugins/plugins/orchestration/skills/orchestration/SKILL.md';
...
## Instructions for Humans {#instructions-for-humans}

### Code Style {#code-style}

I start with code style instructions that are applicable to LLMs and human developers.

<CodeBlock language="markdown" title="orchestration/SKILL.md (Code Style section)">
  {OrchestrationSource}
</CodeBlock>

[View on GitHub](https://github.com/motlin/claude-code-plugins/blob/main/plugins/orchestration/skills/orchestration/SKILL.md)

## Instructions specific to LLMs {#instructions-specific-to-llms}
...
<CodeBlock language="markdown" title="orchestration/SKILL.md (Testing Philosophy section)">
    {OrchestrationSource}
</CodeBlock>
...
<CodeBlock language="markdown" title="orchestration/SKILL.md (Conversation Style section)">
  {OrchestrationSource}
</CodeBlock>
...
<CodeBlock language="markdown" title="orchestration/SKILL.md (Workflow Orchestration section)">
  {OrchestrationSource}
</CodeBlock>
...
### Extra context just for you {#extra-context-just-for-you}
...
<CodeBlock language="markdown" title="orchestration/SKILL.md (LLM Context section)">
  {OrchestrationSource}
</CodeBlock>
...
### Claude's Commit messages {#claudes-commit-messages}
...
## Project-specific CLAUDE.md {#project-specific-claudemd}
