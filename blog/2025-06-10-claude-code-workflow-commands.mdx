...
import CommitCommandSource from '!!raw-loader!../src/claude-code-plugins/plugins/git/commands/commit.md';
...
[View on GitHub](https://github.com/motlin/claude-code-plugins/blob/main/plugins/markdown-tasks/commands/do-one-task.md)
...
[View on GitHub](https://github.com/motlin/claude-code-plugins/blob/main/plugins/git/commands/commit.md)
