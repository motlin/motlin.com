...
date: 2025-07-22
description: "Ever start a long-running Claude Code task and walk away, only to come back later and find it finished ages ago? I solved this by configuring Claude Code to notify me."
---
...
## The Hook Configuration {#the-hook-configuration}
...
## The woof Script {#the-woof-script}
...
## Pushover for Push Notifications {#pushover-for-push-notifications}
...
## Works Great with --dangerously-skip-permissions {#works-great-with---dangerously-skip-permissions}
...
## Yes, It's a WUPHF.com Reference {#yes-its-a-wuphfcom-reference}
