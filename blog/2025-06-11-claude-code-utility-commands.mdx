...
import ConflictsCommandSource from '!!raw-loader!../src/claude-code-plugins/plugins/git/commands/conflicts.md';
...
[View on GitHub](https://github.com/motlin/claude-code-plugins/blob/main/plugins/git/commands/conflicts.md)
